...
import petdori.apiserver.domain.auth.exception.token.InvalidJwtException;
import petdori.apiserver.domain.auth.exception.token.InvalidJwtSignatureException;
import petdori.apiserver.domain.auth.exception.token.UnknownJwtException;
import petdori.apiserver.domain.auth.exception.token.ValidTimeExpiredJwtException;
import petdori.apiserver.domain.auth.service.PetdoriMemberDetailsService;
...
public class JwtProvider {
    ...
    public JwtProvider(@Value("${jwt.access.secret}") String accessSecretKey,
                       ...
                       PetdoriMemberDetailsService PetdoriMemberDetailsService) {
    ...
    public Authentication getAuthenticationFromToken(String accessToken) {
        ...
        PetdoriMemberDetails petdoriMemberDetails = new PetdoriMemberDetails(email, authority);

        return new UsernamePasswordAuthenticationToken(petdoriMemberDetails,
